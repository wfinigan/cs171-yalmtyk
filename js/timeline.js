    ...
    function animateTl(scrolling, el, tl) {
        ...
        function moreInfo() {
            if (action1 % 2 == 0) {
                ...
                document.getElementById("nov8").innerHTML = "-";
        ...
        function moreInfo2() {
            if (action2 % 2 == 0) {
                ...
                document.getElementById("dec15").innerHTML = "-";
                setEqualHeights(el, -500);
                action2++;
                console.log(action2);
            } else {
        ...
        function moreInfo3() {
            if (action3 % 2 == 0) {
                ...
                document.getElementById("mar6").innerHTML = "-";
                setEqualHeights(el, -500);
                action3++;
            } else {
        ...
        function moreInfo4() {
            if (action4 % 2 == 0) {
                ...
                document.getElementById("april2").innerHTML = "-";
                setEqualHeights(el, -500);
                action4++;
            } else {
        ...
        function moreInfo5() {
            if (action5 % 2 == 0) {
                ...
                document.getElementById("june28").innerHTML = "-";
                setEqualHeights(el, -500);
                action5++;
            } else {
        ...
        function moreInfo6() {
            if (action6 % 2 == 0) {
                document.getElementById("oct4").innerHTML = "-";
        ...
        function moreInfo7() {
            if (action7 % 2 == 0) {
                document.getElementById("nov20").innerHTML = "-";
        ...
        function moreInfo8() {
            if (action8 % 2 == 0) {
                document.getElementById("sept24").innerHTML = "-";
